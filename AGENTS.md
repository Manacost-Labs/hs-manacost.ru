...
| Редизайн, дизайн-система и крупное изменение шаблонов | `wordpress-redesign-system`, `newspaper-tagdiv`, `wordpress-accessibility`, `frontend-design`, `playwright`, `web-perf` | Аудит, выбранное направление, валидный design contract, real-content states, 320/390/768/1024/1440 px, visual/accessibility/performance gates, rollback |

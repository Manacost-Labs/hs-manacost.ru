...
class td_page_views {
    ...
    static function update_page_views( $postID ) {
        ...
        // hs-manacost.ru: the primary views writer is the local Go service at /views/hit.
        // Keep Newspaper read/display helpers, but do not let PHP renders increment postmeta.
        return;

...
function hs_reader_comments_assets(): void {
	...
	wp_enqueue_style( 'hs-manacost-reader-ui', $base . 'ui.css', array(), '0.7.1' );
	wp_enqueue_style( 'hs-manacost-reader-comments', $base . 'comments.css', array( 'hs-manacost-reader-ui' ), '0.7.1' );
	wp_enqueue_script(

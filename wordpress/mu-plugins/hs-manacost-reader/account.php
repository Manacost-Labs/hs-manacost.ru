...
function hs_manacost_reader_account_shell( array $config = array() ): string {
	...
	return '<section class="mc-reader mc-reader-ui" aria-label="Кабинет читателя" data-mc-reader-root'
		...
		. '<div class="mc-reader__tabs" data-reader-tabs role="tablist" aria-label="Разделы кабинета" hidden>'
		. '<button class="mc-reader__tab" id="mc-reader-tab-profile" data-reader-tab-profile type="button" role="tab" aria-selected="true" aria-controls="mc-reader-profile-panel">Профиль</button>'
		. '<button class="mc-reader__tab" id="mc-reader-tab-favorites" data-reader-tab-favorites type="button" role="tab" aria-selected="false" aria-controls="mc-reader-favorites-panel">Избранное</button></div>'
		. '<section class="mc-reader__profile" id="mc-reader-profile-panel" role="tabpanel" aria-labelledby="mc-reader-tab-profile mc-reader-profile-title" data-reader-profile-overview hidden>'
		...
		. '<section class="mc-reader__favorites" id="mc-reader-favorites-panel" role="tabpanel" aria-labelledby="mc-reader-tab-favorites" data-reader-favorites hidden><header class="mc-reader__favorites-head"><div><p class="mc-reader__profile-kicker">Личная подборка</p><h2>Сохранённые статьи</h2><p class="mc-ui-help">Материалы, к которым вы хотите вернуться.</p></div></header><p class="mc-reader__favorites-status" data-reader-favorites-status role="status" aria-live="polite"></p><ul class="mc-reader__favorites-list" data-reader-favorites-list></ul><button class="mc-reader__button mc-ui-button mc-ui-button--secondary" data-reader-favorites-more type="button" hidden>Показать ещё</button></section>'

...
function hs_reader_public_profile_shell( string $id ): string {
	...
	return '<section class="mc-reader-ui mc-public-profile" data-mc-public-profile data-reader-id="' . esc_attr( $id ) . '" data-class-icon-base="/wp-content/mu-plugins/hs-manacost-reader/class-icons/" aria-labelledby="mc-public-profile-title">'

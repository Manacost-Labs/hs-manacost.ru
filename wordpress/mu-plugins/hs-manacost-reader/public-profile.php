...
function hs_reader_public_profile_shell( string $id ): string {
	...
	return '<section class="mc-reader-ui mc-public-profile" data-mc-public-profile data-reader-id="' . esc_attr( $id ) . '" aria-labelledby="mc-public-profile-title">'
		...
		. '<span class="mc-public-profile__author-mark mc-public-profile__author-mark--paid" data-public-profile-paid role="img" aria-label="Платный подписчик" title="Платный подписчик" hidden><svg viewBox="0 0 24 24" focusable="false" aria-hidden="true"><path d="m4 8 4.25 3.25L12 5l3.75 6.25L20 8l-1.7 10H5.7L4 8Z"></path><path d="M6.25 20h11.5"></path></svg></span></h1>'
		. '<p data-public-profile-class></p><p data-public-profile-bio></p><nav class="mc-public-profile__socials" data-public-profile-socials aria-label="Ссылки читателя" hidden><p>Где найти</p>'
		. $socials . '</nav></div></section>';
}

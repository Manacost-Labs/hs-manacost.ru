...
function hs_reader_comments_shell(): string {
	...
	return '<section id="reader-comments" class="mc-reader-ui mc-comments" data-mc-comments data-post-id="' . esc_attr( (string) $post_id ) . '" aria-labelledby="reader-comments-title">'
		...
		. '<p class="mc-comments__profile-notice" data-comments-profile-notice hidden>' . esc_html__( 'В прошлых комментариях ещё старое фото, имя или значки. Обновите профиль ниже — новый комментарий не нужен.', 'hs-manacost-reader' ) . '</p>'

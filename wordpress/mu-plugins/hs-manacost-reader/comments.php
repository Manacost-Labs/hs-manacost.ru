...
function hs_reader_comments_shell(): string {
	...
	return '<section id="reader-comments" class="mc-reader-ui mc-comments" data-mc-comments data-post-id="' . esc_attr( (string) $post_id ) . '" aria-labelledby="reader-comments-title">'
		...
		. '<div class="mc-comments__composer-heading"><div class="mc-comments__composer-identity"><h3>' . esc_html__( 'Написать комментарий', 'hs-manacost-reader' ) . '</h3><div class="mc-comments__me" data-comments-me></div></div><a class="mc-ui-button mc-ui-button--text" href="/account/">' . esc_html__( 'Изменить профиль', 'hs-manacost-reader' ) . '</a></div>'
		...
		. '<div class="mc-comments__attachment" data-comments-attachment><input id="reader-comment-attachment" data-comments-attachment-input type="file" accept="image/jpeg,image/png,image/webp" hidden><button class="mc-ui-button mc-ui-button--secondary mc-comments__attachment-picker" type="button" data-comments-attachment-picker aria-describedby="reader-comment-attachment-help"><svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 4v10m0-10 4 4m-4-4L8 8M5 14v4a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-4"/></svg><span>' . esc_html__( 'Прикрепить изображение', 'hs-manacost-reader' ) . '</span></button><p id="reader-comment-attachment-help" class="mc-ui-help">' . esc_html__( 'JPEG, PNG или WebP до 4 МБ. Можно вставить скриншот из буфера: Ctrl+V.', 'hs-manacost-reader' ) . '</p><div class="mc-comments__attachment-preview" data-comments-attachment-preview hidden><img data-comments-attachment-image alt="Предпросмотр вложения"><div><p data-comments-attachment-status></p><button class="mc-ui-button mc-ui-button--text" type="button" data-comments-attachment-remove>' . esc_html__( 'Убрать изображение', 'hs-manacost-reader' ) . '</button></div></div></div>'
		. '<div class="mc-comments__profile-sync"><p class="mc-comments__profile-notice" data-comments-profile-notice hidden>' . esc_html__( 'В прошлых комментариях ещё старое фото, имя или значки. Обновите профиль — новый комментарий не нужен.', 'hs-manacost-reader' ) . '</p><button class="mc-ui-button mc-ui-button--secondary" type="button" data-comments-refresh-profile hidden>' . esc_html__( 'Обновить профиль в комментариях', 'hs-manacost-reader' ) . '</button></div>'
		. '<div class="mc-comments__composer-footer"><button class="mc-ui-button" type="submit" data-comments-submit>' . esc_html__( 'Опубликовать', 'hs-manacost-reader' ) . '</button></div></form>'

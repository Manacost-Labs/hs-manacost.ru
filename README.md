...
Базовый quality gate включает тестирование, code review, упрощение, security-проверку и Git-процесс. Для UI автоматически добавляются дизайн, доступность и browser testing; для SEO — техническое SEO и профильные проверки; для производительности — измерения Core Web Vitals до и после изменения.

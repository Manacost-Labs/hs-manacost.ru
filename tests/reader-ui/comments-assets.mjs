...
foreach(array('ui.css','comments.css','public-profile.css','comments.js','community-ui.js','public-profile.js','reader.js','profile-editor.js','article-favorite.css','article-favorite.js') as $file){
...
for (const [environment, reader, comments, host, enabled] of [
  ...
  for (const [hook, patterns] of Object.entries(result.rules)) {
    ...
    for (const file of ['ui.css', 'comments.css', 'public-profile.css', 'comments.js', 'community-ui.js', 'public-profile.js', 'reader.js', 'profile-editor.js', 'article-favorite.css', 'article-favorite.js']) {
